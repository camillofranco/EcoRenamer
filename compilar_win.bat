...
echo ==========================================================
echo       🏗️ COMPILADOR ECOWAVE PRO v1.9.2 (WIN - CLEAN)
echo ==========================================================
...
powershell -Command "Compress-Archive -Path 'dist\RenomeadorApp\*' -DestinationPath 'EcoRenamer_Win_v1.9.2.zip' -Force"
