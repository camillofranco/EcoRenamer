...
echo ==========================================================
echo       🏗️ COMPILADOR ECOWAVE PRO v1.4.0 (WINDOWS)
echo ==========================================================
...
powershell -Command "Compress-Archive -Path 'dist\RenomeadorApp\*' -DestinationPath 'EcoRenamer_Win_v1.4.0.zip' -Force"

echo --------------------------------------------------------
echo ✅ SUCESSO ABSOLUTO!
echo O arquivo pronto para o GitHub: EcoRenamer_Win_v1.4.0.zip
