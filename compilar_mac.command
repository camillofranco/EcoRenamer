...
echo "=========================================================="
echo "      🏗️ COMPILADOR ECOWAVE PRO v1.4.2 (MACOS)"
echo "=========================================================="
...
cd dist
zip -ry ../EcoRenamer_Mac_v1.4.2.zip RenomeadorApp.app
cd ..

echo "--------------------------------------------------------"
echo "✅ SUCESSO ABSOLUTO!"
echo "O arquivo pronto para o GitHub é: EcoRenamer_Mac_v1.4.2.zip"
